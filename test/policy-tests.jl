...
@testset "Policies" begin
    @test begin
        ...
        initial_state = State(; on_hand_inventory = Dict(storage => Dict(p => 0), 
                                ...
                                pending_order_lines = Dict(storage => OrderLine[], storage2 => OrderLine[]),
        ...
        println("holding costs: $(get_holding_costs(final_state))")
